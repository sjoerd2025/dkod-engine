    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.DeepReview(
          diff,context,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ReviewVerdict
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async JudgeChangeset(
        summary: string,review_notes: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ReviewVerdict> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.JudgeChangeset(
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "JudgeChangeset",
            {
            "summary": summary,"review_notes": review_notes
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
        ...
        async PlanWorkflow(
        intent: string,repo_context: string,
        __baml_options__?: BamlCallOptions<never>
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "PlanWorkflow",
            {
            "intent": intent,"repo_context": repo_context
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
            ...
            diff: string,context: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ReviewVerdict, types.ReviewVerdict>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for DeepReview", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ReviewVerdict, types.ReviewVerdict>(
                  __raw__,
                  (a): partial_types.ReviewVerdict => a,
                  (a): types.ReviewVerdict => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for JudgeChangeset", error);
              }
              }
              };
              }
